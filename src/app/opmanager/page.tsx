...
const Page = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', bgcolor: blue[200], p: 3 }}>
            {/* 제목 */}
            ...
            <Box>
                ...
                <Box sx={{ flex: 1, p: 0, mb: 2 }}>
                    ...
                    />
                    <IconButton sx={{ marginLeft: 1, bgcolor: 'white', padding: 1, borderRadius: '50%', '&:hover': { bgcolor: grey[300] } }}>
                    ...
                    <Box sx={{ width: '350px', height: '300px', overflowY: 'auto', overflowX: 'hidden' }}>
                        {filteredUserList.length > 0 ? (
                            filteredUserList.map((user, index) => (
                                <Box key={user.id || index} sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: 0, mb: 6 }}>
